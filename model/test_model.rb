...
class TestModel < Minitest::Unit::TestCase
  ...
  def test_control_e7; assert_equal("Coal power capacity", worksheet.control_e7); end
  def test_control_e8; assert_equal("Coal power technology", worksheet.control_e8); end
  def test_control_e9; assert_equal("Gas power stations", worksheet.control_e9); end
  def test_control_e10; assert_equal("Liquid fuel power stations", worksheet.control_e10); end
  def test_control_e11; assert_equal("Nuclear power stations", worksheet.control_e11); end
  def test_control_e12; assert_equal("Offshore wind", worksheet.control_e12); end
  def test_control_e13; assert_equal("Onshore wind", worksheet.control_e13); end
  def test_control_e14; assert_equal("Small-scale wind", worksheet.control_e14); end
  def test_control_e15; assert_equal("Wave", worksheet.control_e15); end
  def test_control_e16; assert_equal("Tidal range", worksheet.control_e16); end
  def test_control_e17; assert_equal("Solar panels for electricity", worksheet.control_e17); end
  def test_control_e18; assert_equal("Geothermal electricity", worksheet.control_e18); end
  def test_control_e19; assert_equal("Hydroelectric power stations", worksheet.control_e19); end
  ...
  def test_control_e24; assert_equal("Bioenergy from marginal land", worksheet.control_e24); end
  def test_control_e25; assert_equal("Bioenergy from agri land", worksheet.control_e25); end
  def test_control_e26; assert_equal("End use bionenergy", worksheet.control_e26); end
  def test_control_e27; assert_equal("Waste to Energy Conversion", worksheet.control_e27); end
  ...
  def test_control_e32; assert_equal("Shift to zero emission transport", worksheet.control_e32); end
  def test_control_e33; assert_equal("Choice of fuel cells or batteries", worksheet.control_e33); end
  ...
  def test_control_e37; assert_equal("Urban: Lighting and appliances", worksheet.control_e37); end
  def test_control_e38; assert_equal("Rural: Lighting and appliances", worksheet.control_e38); end
  def test_control_e39; assert_equal("Industry output growth", worksheet.control_e39); end
  def test_control_e40; assert_equal("Energy technology in industry", worksheet.control_e40); end
  def test_control_e41; assert_equal("Commercial demand for cooling", worksheet.control_e41); end
  def test_control_e42; assert_equal("Commercial lighting and appliances", worksheet.control_e42); end
  def test_control_e43; assert_equal("Fertility and population growth", worksheet.control_e43); end
  ...
  def test_control_e46; assert_equal("Growth in gross domestic product", worksheet.control_e46); end
  ...
  def test_control_f3; assert_equal("0.4.3.4", worksheet.control_f3); end
